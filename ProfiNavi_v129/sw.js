const CACHE='profinavi-v129';
const CORE=['./','./index.html','./client.html','./style.css','./icon.svg','./icon-192.png','./icon-512.png','./manifest.webmanifest','./pn-data.js','./pn-ranking.js','./pn-pwa.js','./pn-i18n.js'];
